...
-- solution:
with cte as (
select P.session_id,P.customer_id, P.start_time, P.end_time, A.timestamp,
sum((case when A.timestamp between P.start_time and P.end_time then 1 else 0 end)) as det
from Playback P
