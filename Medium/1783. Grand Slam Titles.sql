...
((select count(*) from championships where wimbledon=p.player_id) +
(select count(*) from championships where fr_open=p.player_id) +
(select count(*) from championships where us_open=p.player_id) +
(select count(*) from championships where au_open=p.player_id)) as grand_slams_count
from players p 
